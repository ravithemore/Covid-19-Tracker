...
function App() {
  ...
  const handleOnclick = ()=>{
    window.location.replace("http://localhost:3000/hospitals")
      ...
      <div className="app">
        <div className='app_left'>
          <div className="app_header">
            <h1 className='myheading'>COVID-19 TRACKER </h1>
            <button onClick={handleOnclick}>Hospitals</button>

            <FormControl className="app_dropdown">
              <Select className='myselect' variant="outlined" onChange={onCountryChange} value={country}>
